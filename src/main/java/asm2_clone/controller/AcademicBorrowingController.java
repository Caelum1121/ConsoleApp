...
public class AcademicBorrowingController {
    ...
    public void setAcademic(AcademicStaff academic) {
        ...
        this.records = LendingRecordDAO.getRecordsByAcademicId(academic.getId());
        updateDisplay();
    }
    ...
    private void initialize() {
        ...
        searchField.textProperty().addListener((obs, oldText, newText) -> updateDisplay());
